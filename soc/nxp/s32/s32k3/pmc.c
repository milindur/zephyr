 ...
 */
#undef PMC_CONFIG_FASTREC_MASK
#undef PMC_CONFIG_FASTREC
#undef PMC_CONFIG_HVDIE_MASK
#undef PMC_CONFIG_HVDIE
#undef PMC_CONFIG_LMBCTLEN_MASK
#undef PMC_CONFIG_LMBCTLEN
#undef PMC_CONFIG_LMEN_MASK
#undef PMC_CONFIG_LMEN
#undef PMC_CONFIG_LPM25EN_MASK
#undef PMC_CONFIG_LPM25EN
#undef PMC_CONFIG_LVDIE_MASK
#undef PMC_CONFIG_LVDIE
#undef PMC_CONFIG_LVRBLPEN_MASK
#undef PMC_CONFIG_LVRBLPEN
#undef PMC_LVSC_GNG11OSCF_MASK
#undef PMC_LVSC_GNG11OSCF
#undef PMC_LVSC_GNG25OSCF_MASK
#undef PMC_LVSC_GNG25OSCF
#undef PMC_LVSC_HVD11F_MASK
#undef PMC_LVSC_HVD11F
#undef PMC_LVSC_HVD11S_MASK
#undef PMC_LVSC_HVD11S
#undef PMC_LVSC_HVD25F_MASK
#undef PMC_LVSC_HVD25F
#undef PMC_LVSC_HVD25S_MASK
#undef PMC_LVSC_HVD25S
#undef PMC_LVSC_HVDAF_MASK
#undef PMC_LVSC_HVDAF
#undef PMC_LVSC_HVDAS_MASK
#undef PMC_LVSC_HVDAS
#undef PMC_LVSC_HVDBF_MASK
#undef PMC_LVSC_HVDBF
#undef PMC_LVSC_HVDBS_MASK
#undef PMC_LVSC_HVDBS
#undef PMC_LVSC_LVD5AF_MASK
#undef PMC_LVSC_LVD5AF
#undef PMC_LVSC_LVD5AS_MASK
#undef PMC_LVSC_LVD5AS
#undef PMC_LVSC_LVR11F_MASK
#undef PMC_LVSC_LVR11F
#undef PMC_LVSC_LVR11LPF_MASK
#undef PMC_LVSC_LVR11LPF
#undef PMC_LVSC_LVR25F_MASK
#undef PMC_LVSC_LVR25F
#undef PMC_LVSC_LVR25LPF_MASK
#undef PMC_LVSC_LVR25LPF
#undef PMC_LVSC_LVRAF_MASK
#undef PMC_LVSC_LVRAF
#undef PMC_LVSC_LVRALPF_MASK
#undef PMC_LVSC_LVRALPF
#undef PMC_LVSC_LVRBF_MASK
#undef PMC_LVSC_LVRBF
#undef PMC_LVSC_LVRBLPF_MASK
#undef PMC_LVSC_LVRBLPF
#undef PMC_LVSC_PORF_MASK
#undef PMC_LVSC_PORF
#undef PMC_VERID_LMFEAT_MASK
#undef PMC_VERID_LMFEAT
#undef PMC_VERID_MAJOR_MASK
#undef PMC_VERID_MAJOR
#undef PMC_VERID_MINOR_MASK
#undef PMC_VERID_MINOR
...
static int pmc_init(const struct device *dev)
{
	...
	if (DT_INST_PROP(0, lm_reg)) {
		uint32_t cur = REG_READ(PMC_CONFIG);

		/*
		 * If the Last Mile regulator is already running (e.g. enabled by
		 * the boot ROM), do not clear LMEN: on boards where V15 is
		 * generated by an external BJT controlled by the PMC, dropping
		 * LMEN cuts the base drive and collapses the V15 supply.
		 *
		 * The devicetree stays authoritative for the other Last Mile
		 * fields: LMBCTLEN resets to 1 on derivatives where LMEN is
		 * read-only (e.g. S32K358) and must be cleared by software
		 * when no external BJT is fitted.
		 */
		if ((cur & PMC_CONFIG_LMEN_MASK) != 0U) {
			cur &= ~(PMC_CONFIG_LMBCTLEN_MASK | PMC_CONFIG_LMAUTOEN_MASK);
			REG_WRITE(PMC_CONFIG, cur | reg_val);
			return 0;
		}
